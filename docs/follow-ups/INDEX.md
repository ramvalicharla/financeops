...
| FU-019 | [control_plane_*.test.tsx pre-existing failures unmasked after Phase 2 useSearchParams fix](./FU-019-control-plane-test-preexisting-failures.md) | 2026-04-26 | Phase 2 close — Step 11.5 |
