...
/**
 * Props for the shared slide-in sheet primitive.
 */
export interface SheetProps {
  ...
  /** Main sheet content. */
  children: ReactNode
  /** Tailwind width utility for the sheet panel. */
  width?: string
}

/**
 * Accessible right-side sheet with focus management, backdrop dismissal, and Escape handling.
 */
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div
        ...
        aria-modal="true"
        className={cn(
          "relative z-10 flex h-full w-full flex-col overflow-hidden border-l border-border bg-card shadow-2xl outline-none transition-transform duration-200",
          width,
