...
function SnoozeDialog({
  ...
  return (
    <Dialog open={Boolean(state)} onClose={onClose} title="Snooze alert" size="sm">
      ...
      <section className="rounded-lg border border-border bg-card p-4">
        ...
        {!!alerts.length ? (
          <div className="overflow-x-auto rounded-md border border-border">
            <table aria-label="Financial anomalies" className="w-full min-w-[1080px] text-sm">
              <thead>
                <tr className="bg-muted/30">
                  <th scope="col" className="px-3 py-2 text-left font-medium text-foreground">Type</th>
                  <th scope="col" className="px-3 py-2 text-left font-medium text-foreground">Severity</th>
                  <th scope="col" className="px-3 py-2 text-left font-medium text-foreground">Category</th>
                  <th scope="col" className="px-3 py-2 text-left font-medium text-foreground">Detected</th>
