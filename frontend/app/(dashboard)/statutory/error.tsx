...
export default function StatutoryErrorBoundary({ error, reset }: ErrorBoundaryProps) {
  useEffect(() => {
    // Log to error reporting (Sentry is already configured in the API client)
    console.error("[Statutory] Runtime error:", error)
  }, [error])
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] space-y-5 p-8">
      ...
      <div className="text-center space-y-2">
        <h2 className="text-lg font-semibold text-foreground">Statutory encountered an error</h2>
