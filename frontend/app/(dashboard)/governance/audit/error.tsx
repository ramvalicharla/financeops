...
export default function AuditErrorBoundary({ error, reset }: ErrorBoundaryProps) {
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] space-y-5 p-8">
      ...
      <div className="text-center space-y-2">
        <h2 className="text-lg font-semibold text-foreground">Audit encountered an error</h2>
