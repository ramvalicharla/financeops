            ...
            <table className="min-w-full divide-y divide-border text-sm">
              <thead className="bg-muted/30">
                <tr className="text-left text-xs uppercase tracking-wide text-muted-foreground">
                  ...
                  <th className="px-4 py-2">Amortised</th>
      ...
      {createModalOpen ? (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/70 p-4">
          <div className="w-full max-w-xl rounded-xl border border-border bg-card p-5">
            <h2 className="text-lg font-semibold text-foreground">Add Prepaid Schedule</h2>
            <div className="mt-4 grid gap-3 md:grid-cols-2">
              ...
              />
              <Input value={totalAmount} onChange={(event) => setTotalAmount(event.target.value)} placeholder="Total amount" />
              <Input
                type="date"
                value={coverageStart}
      ...
      {runModalOpen ? (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/70 p-4">
          <div className="w-full max-w-lg rounded-xl border border-border bg-card p-5">
            <h2 className="text-lg font-semibold text-foreground">Run Amortisation Period</h2>
