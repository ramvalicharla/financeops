...
export const metadata = createMetadata("Data Processing Agreement")

export default function DPAPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      <h1 className="mb-2 text-3xl font-semibold text-foreground">Data Processing Agreement</h1>
      <p className="mb-10 text-sm text-muted-foreground">This DPA forms part of the Terms of Service between Finqor and Customer.</p>
      <div className="space-y-8 text-foreground">
        ...
        <section>
          ...
          <p>Finqor processes customer data only on documented customer instructions in the product contract.</p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>Finqor will notify customer contacts within contractual timelines with incident details and mitigation actions.</p>
        </section>
        <section>
