  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="space-y-8 text-foreground">
        ...
        <section>
          <h2 className="mb-3 text-xl font-semibold text-foreground">3. How We Use Data</h2>
        ...
        <section>
          <h2 className="mb-3 text-xl font-semibold text-foreground">4. Data Localisation</h2>
        ...
        <section>
          <h2 className="mb-3 text-xl font-semibold text-foreground">5. Your DPDP Rights</h2>
        ...
        <section>
          <h2 className="mb-3 text-xl font-semibold text-foreground">8. Grievance Officer</h2>
