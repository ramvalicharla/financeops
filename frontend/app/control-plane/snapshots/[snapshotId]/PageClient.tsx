...
export default function SnapshotDetailPage() {
  ...
  const id = params?.snapshotId ?? null
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6 p-6">
      ...
      <div className="text-center space-y-2">
        <h1 className="text-2xl font-semibold text-foreground">Snapshot Detail</h1>
        <p className="text-sm text-muted-foreground max-w-md">Platform snapshot details and restore options.</p>
        {id ? (
