...
export default function AirlockItemPage() {
  const params = useParams()
  const id = params?.itemId ?? null
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6 p-6">
      ...
      <div className="text-center space-y-2">
        <h1 className="text-2xl font-semibold text-foreground">Airlock Item</h1>
        <p className="text-sm text-muted-foreground max-w-md">Platform airlock entry review and disposition.</p>
        {id ? (
