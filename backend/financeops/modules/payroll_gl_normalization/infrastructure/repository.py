...
class PayrollGlNormalizationRepository:
    ...
    async def insert_run(
        ...
        *,
        ...
        created_by: uuid.UUID,
        created_by_intent_id: uuid.UUID | None = None,
        recorded_by_job_id: uuid.UUID | None = None,
    ) -> NormalizationRun:
        return await AuditWriter.insert_financial_record(
            self._session,
            ...
            record_data={
                ...
                "run_type": run_type,
                "run_token": run_token,
                "source_airlock_item_id": str(source_airlock_item_id) if source_airlock_item_id else "",
            },
            values={
                "organisation_id": organisation_id,
                "source_id": source_id,
                ...
                "source_airlock_item_id": source_airlock_item_id,
                "source_type": source_type,
                "source_external_ref": source_external_ref,
                "created_by_intent_id": created_by_intent_id,
                "recorded_by_job_id": recorded_by_job_id,
                "run_token": run_token,
